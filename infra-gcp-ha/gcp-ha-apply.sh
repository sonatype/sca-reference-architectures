...
show_next_steps() {
    ...
    print_status "━━━━━━━━━━━━"
    print_status "1. Access IQ Server (wait 10-15 minutes for initialization)"
    print_status "2. Default credentials: admin / admin123"
    print_status "3. Monitor deployment health and verify HA functionality"
    echo ""
    ...
    print_warning "• Test failover scenarios to validate HA setup"
    echo ""
