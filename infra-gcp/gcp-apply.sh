...
show_next_steps() {
    ...
    print_status "=========="
    echo ""
    print_status "🎉 Your Nexus IQ Server infrastructure has been deployed!"
    echo ""
    print_status "📋 Immediate Actions:"
    print_status "   1. Wait 5-10 minutes for all services to fully initialize"
    print_status "   2. Access Nexus IQ Server via the URL shown above"
    print_status "   3. Complete the initial setup wizard"
    print_status "   4. Configure your first application scan"
    echo ""
    print_status "🔧 Configuration Tasks:"
    print_status "   1. Set up DNS records if using custom domains"
    print_status "   2. Configure SSL certificates if needed"
    print_status "   3. Review and customize monitoring alerts"
    print_status "   4. Set up backup and disaster recovery procedures"
    echo ""
    ...
    echo ""
    print_warning "💡 Tip: Save the output above for your records!"
}
